...
Breadcrumbs::register('banner_ctr', function ($breadcrumbs) {
    $breadcrumbs->parent('advert');
    $breadcrumbs->push(trans('Advert::module.banner_ctr.title'), url(config('advert.models.banner_ctr.resource_url')));
});